...
## Install on Mac
Quick Start:
- Stable (main): [Download latest release](https://github.com/maxacode/LockPilot-Mac-Win/releases/latest)
- Dev (dev): [View latest dev prereleases](https://github.com/maxacode/LockPilot-Mac-Win/releases)
...
- `https://api.github.com/repos/maxacode/LockPilot-Mac-Win/releases`
